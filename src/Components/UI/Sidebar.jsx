...
const SideBar = () => {
  ...
  const linksMenu = [
    {
      ...
      text: "Dashboard",
      path: "/",
      icon: <ion-icon name="stats-chart"></ion-icon>,
    },
    {
      id: 2,
      text: "Food Order",
  ...
  return (
    <div
      className={
        isSidebarOpen
          ? "-ml-[240px] ease-out duration-300 w-[240px]  "
          : "ml-0 ease-out duration-300 w-[240px]"
      }
    >
      <div className="fixed bg-[#F1F2F7] md:block w-[240px] h-screen ">
        ...
        <div className="pt-5 pl-[15%]">
          <div className="flex flex-col items-start gap-2   ">
            <h1 className="text-xs text-[#082431] opacity-50 uppercase pl-2">
              Menu
            </h1>
            {linksMenu.map((link) => {
        ...
        <div className="pt-3 pl-[15%]">
          <div className="flex flex-col items-start gap-2   ">
            <h1 className="text-xs text-[#082431] opacity-50 uppercase font-normal pl-2">
              Other
            </h1>
            {linkOther.map((link) => {
              const { text, path, id, icon } = link;
